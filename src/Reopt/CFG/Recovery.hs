...
data RecoverError w
   = RecoverErrorAt !ReoptFailureTag !(MemAddr w) !String
...
runFunRecover :: FunRecoverContext ids
              -> FunRecover ids a
              -> Either (ReoptFailureTag, String) ([String], a)
runFunRecover ctx m =
...
throwErrorAt :: ReoptFailureTag -> String -> Recover ids a
    ...
    IVDomain (RegEqualLoc lr) ms -> do
      ...
      case MapF.lookup lr m of
        Nothing -> do
          ...
          throwErrorAt ReoptInternalErrorTag $
...
x86BlockInvariants
  ...
  -> Either (ReoptFailureTag, String) (BlockInvariantMap X86_64 ids)
...
recoverFunction :: forall ids
                ...
                -> Either (ReoptFailureTag, String) ([String], Function X86_64)
